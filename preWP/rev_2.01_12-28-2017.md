...
### Как это работает? Базовые предпосылки.
...
# [Use case основателя/ студента?](https://github.com/SerendipityLab/CFSP/blob/master/usercase/foundercase.md)

Пока у основателя или студента нет никакой истории и шансов получить финансирование из традиционных истчников, они получают грант от экосистемы в токенах, которыми могут оплачивать свое развитие до момента, когда им станут предлагать поддержку.

# [Use case инвестора, профессионала](https://github.com/SerendipityLab/CFSP/blob/master/usercase/investors.md)?
