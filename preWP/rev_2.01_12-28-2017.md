...
инициатор, кто воспринял и кто зажигает, он отправляет запрос на ресурсы, и у него есть интенция изменения (что хочет изменить и почему), у него есть видение (что хочет) и есть представление/ гипотеза о способе. он имеет А и Э мотивацию. А: реализовать свое видение Э: получить выгоду, если люди будут пользоваться…. должен быть механизм воздаяния и поддержки. 

Потребность инициаторов сырых идей: - Нужна помощь, советы, возможность привлекать людей и немного денег на развитие своей идеи, или по крайней мере доступ к инвесторам, аудитории, клиентам. Разумеется, есть те, кто способен сам. Таких 1%, и они не моя ЦГ. 
Проблема инициаторов сырых идей: - Их никто не знает, никто не хочет тратить на них время. 



спонсор - тот, у кого есть отчуждаемые ресурсы, и кто готов их предоставить при условиях, что ему нравится 1) видение, и он 2) разделяет намерение, он испытывает 3) определенное доверие к инициатору/ команде и его 4) способу. Также спонсор может выбирать объем и условия поддержки, которые зависят от параметров 1-4. предполагается, что у спонсора два типа мотивации - альтруистическая - т.е. он хочет, чтобы намерение воплотилось, потому что это соответствует его ценностям - высшие (долгосрочные выгоды) выгоды + эгоистическая - т.е. он надеется получить краткосрочную выгоду от поддержки


помощник - тот, кто тот, у кого есть персональные ресурсы в виде времени, квалификации, репутации, связей, и кто готов их предоставить при условиях, что ему нравится 1) видение, и он 2) разделяет намерение, он испытывает 3) определенное доверие к инициатору/ команде и его 4) способу. Также помощник может выбирать объем и условия поддержки, которые зависят от параметров 1-4. предполагается, что у спонсора два типа мотивации - альтруистическая - т.е. он хочет, чтобы намерение воплотилось, потому что это соответствует его ценностям - высшие (долгосрочные выгоды) выгоды + эгоистическая - т.е. он надеется получить краткосрочную выгоду от поддержки.

Потребность экспертов, менторов, специалистов, инвесторов:

Хотя помогать проектам за деньги или за опцион того или иного типа. Хотят реализовать себя. Хотят инвестировать в интересные проекты.

Проблема экспертов, менторов, специалистов:

Не хотят сами заниматься маркетингом и привлекать клиентов, не хотят искать проекты, не хотят тратить время на спам проекты, не могут найти нормальные проекты. Много СКАМА.
